...
//    List<WebSite> findAllByName(String name);
    ...
    @NativeQuery(value = "select t.name,t.version,t.url,t.description,t.is_deleted,t.creator,t.create_time,t.id,t.update_time,t.updater from t_website t where name=?1")
    List<WebSite> findAllByName(String name);
}
